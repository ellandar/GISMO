...
CREATE TABLE JIRA_VERSION (
  id int(11) NOT NULL,
  jira_name varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  gismo_name varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE JIRA_TASK (
  ...
  affVersion varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
ALTER TABLE JIRA_PROJECT
  ...
  MODIFY id int(11) NOT NULL AUTO_INCREMENT,
  ADD CONSTRAINT JIRA_PROJECT_ibfk_1 FOREIGN KEY (project_id) REFERENCES GISMO_PROJECT (id) ON DELETE SET NULL ON UPDATE NO ACTION;
