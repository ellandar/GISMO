...
export class VersionDetailComponent implements OnInit, OnDestroy {
    ...
    @Output() onSaveClicked = new EventEmitter<Version>();
    @Output() onCancelClicked = new EventEmitter();

    constructor(private route: ActivatedRoute, private router: Router, private messageService: MessageService, private versionService: VersionService) {
    }
    ...
    ngOnInit() {
        ...
        this.params_subscription = this.route.params.subscribe(params => {
            let id = params['id'];
            console.log('ngOnInit for version-detail ' + id);

            if (id === 'new') {
                this.version = new Version();
            } else {
                this.versionService.getVersion(id)
                    .subscribe(version => {
        ...
        this.versionService.update(this.version).
            subscribe(
                version => {
                    this.version = version;
                    if (this.sub) {
                        this.onSaveClicked.emit(this.version);
