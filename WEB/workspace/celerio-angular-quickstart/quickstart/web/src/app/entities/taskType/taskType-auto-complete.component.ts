...
export const TASKTYPE_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => TaskTypeCompleteComponent),
    multi: true
};
	...
	template: `
        <p-autoComplete [(ngModel)]="value" [disabled]="disabled" placeholder="Hint: type to search..." field="name" [suggestions]="suggestions" (completeMethod)="complete($event)" (onSelect)="select($event)">
            <ng-template let-taskType pTemplate="item">
                <taskType-line [taskType]="taskType"></taskType-line>
            </ng-template>
        </p-autoComplete>
	`,
	selector: 'taskType-auto-complete',
    providers: [TASKTYPE_AUTO_COMPLETE_CONTROL_VALUE_ACCESSOR]
})
export class TaskTypeCompleteComponent implements ControlValueAccessor {
    @Input() disabled : boolean = false;
    @Input() id : string;
    @Input() name : string;

    //The internal data model
    private _value: TaskType = null;

    public suggestions : TaskType[] = [];

    //Placeholders for the callbacks
    private _onTouchedCallback: () => void = () => {};
    private _onChangeCallback: (_:any) => void = () => {};

    constructor(private taskTypeService : TaskTypeService, private messageService : MessageService) {
    }
    ...
    complete(event:any) {
        this.taskTypeService.complete(event.query).
            subscribe(
